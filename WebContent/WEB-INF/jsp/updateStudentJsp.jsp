    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<form action="${pageContext.request.contextPath }/student/updateStudent2.action" method="post">
 		id：<input class="form-control" type="text" name="id" value="${requestScope.student.id }" readonly="readonly"/><br/>
   		    姓名：<input class="form-control" type="text" name="name" value="${requestScope.student.name }"/><br/>
  		     年龄：<input class="form-control" type="text" name="age" value="${requestScope.student.age }"/><br/>
		       性别：<input class="form-control" type="text" name="gender" value="${requestScope.student.gender }"/><br/>
	 	      地址：<input class="form-control" type="text" name="address" value="${requestScope.student.address }"/><br/>
	  	        生日(xxxx-xx-xx)：<input class="form-control" type="text" name="birthday" value="${requestScope.student.birthday }"/><br/>
